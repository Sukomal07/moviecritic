    ...
    return (
        <div className='w-full p-4 border-2 border-gray-400 flex flex-col gap-6'>
            <div className='flex justify-between items-center'>
                <p className='text-xl font-medium break-words max-w-[90%]'>{comment}</p>
                <p className='text-[#615CF2] text-2xl font-semibold'> {formatRating(rating)} / 10</p>
            </div>
            <div className='flex justify-between items-center'>
                <h1 className='text-xl font-semibold text-slate-600 break-words max-w-[90%]'>By {reviewer ? reviewer : " Anonymous"}</h1>
